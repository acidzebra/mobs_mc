...
local wolf = {
	...
	specific_attack = {"dmobs:fox", "mobs_mc:chicken", "mobs_mc:pig", "mobs_mc:sheep", "mobs_mc:rabbit", "dmobs:badger", "arctic_life:penguin", "arctic_life:walrus", "mobs_animal:penguin"},
	runaway_from = {"mobs_mc:brown_bear", "mobs_mc:polar_bear"},
